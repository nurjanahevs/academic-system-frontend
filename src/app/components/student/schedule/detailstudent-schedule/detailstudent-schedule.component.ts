...
@Component({
  selector: 'app-detailstudent-schedule',
  templateUrl: './detailstudent-schedule.component.html',
  styleUrls: ['./detailstudent-schedule.component.css']
})
export class DetailstudentScheduleComponent implements OnInit {
  spinner = false;
  idCalendar: any;
