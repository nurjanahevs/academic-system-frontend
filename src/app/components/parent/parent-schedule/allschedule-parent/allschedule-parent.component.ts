...
@Component({
  selector: 'app-allschedule-parent',
  templateUrl: './allschedule-parent.component.html',
  styleUrls: ['./allschedule-parent.component.css']
})
export class AllscheduleParentComponent implements OnInit {
  events: any[] = [];
  getEvent: any[] = [];
  ...
  public handleEventClick(event: any) {
    ...
    this.router.navigate(['/parent/schedule/detailSchedule/' + this.selectedSchedule]);
